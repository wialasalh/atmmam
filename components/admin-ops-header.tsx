...
export function AdminOpsHeader({ active }: { active: AdminSection }) {
  return <><header className="ops-header">
    ...
    <div className="ops-account"><a href="/admin/settings" aria-label="الإعدادات">⚙</a><a href="/admin/followups" className="ops-bell" aria-label="الإشعارات">♧<b></b></a><span>ح</span></div>
